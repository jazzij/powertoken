...
def run_tests():
	...
	try:
		assert logmanager.insert_log(user["id"], 0.5, 0.25, 500000)
	except AssertionError as e:
	...
	activity1_json = {
		...
		"duration": 60,
		"repeat": "weekly",
		"repeatEnd": datetime(2019, 1, 12, 13, 0).strftime(common.WC_FORMAT)
	}
	...
	try:
		assert not activitymanager.activity_exists(activity2_id)
	except AssertionError as e:
		print('assert not activitymanager.activity_exists(activity2_id) failed')
	except Exception as e:
		print(e)
